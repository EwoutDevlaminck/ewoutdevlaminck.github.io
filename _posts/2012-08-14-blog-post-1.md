...
<ins>‘Data-Driven Discovery of Coordinates and Governing Equations’ [2]<ins> explores how we can find the appropriate coordinates in which to describe our system. 
Say that it is feasible that a nonlinear embedding can allow for the dynamics to be described my much simpler terms, perhaps even linear terms or simple period ones! Read champions comments on this!
